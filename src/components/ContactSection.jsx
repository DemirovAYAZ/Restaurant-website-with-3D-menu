        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div>
            ...
            <div className="space-y-6 mb-8">
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-gray-600">info@restohub.com</p>
                </div>
              </div>
            ...
            <div className="bg-gray-100 p-6 rounded-lg">
              ...
              <p className="text-gray-600 text-sm">
                Planning a special occasion? We offer private dining rooms and catering services 
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full bg-orange-400 hover:bg-orange-500 text-black py-3 px-6 rounded-lg font-semibold transition-colors duration-300"
              >
                Make Reservation
              </button>
            </form>

    ...
    <footer className="bg-black text-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-6 max-w-md">
              Experience fine dining with our exquisite menu crafted by world-class chefs. 
              We bring you authentic flavors and exceptional service in a warm, inviting atmosphere.
            </p>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-300">
          <p>&copy; 2024 RestoHub. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
